        ...
        <div class="row">
            ...
            <div class="row button">
                ...
                <div class="row title-table">
                    ...
                    <div class="col-3">Логін</div>
                    <div class="col-4">Email</div>
                    <div class="col-2">Роль</div>
                    <div class="col-2">Дія</div>
                </div>
                <?php foreach($users as $key => $value): ?>
                    <div class="row post">
                        <div class="id col-1"><?= $key + 1?></div>
                        <div class="title col-3"><?= $value['username']?></div>
                        <div class="title col-4"><?= $value['email']?></div>
                        ...
                        <div class="delete col-1"><a href="index.php?delete_id=<?= $value['id']?>">delete</a></div>
                    </div>
                <?php endforeach?>    
            </div>
        </div>
